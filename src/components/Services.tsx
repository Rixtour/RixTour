  ...
  const services = [
    {
      ...
      description:
        "Yuqori malakali tarjimonlar bilan til to'siqlarisiz sayohat qiling.",
      icon: Languages,
    ...
    },
    {
      ...
      description:
        "Eng yaxshi mehmonxonalarni topish va professional bron qilish xizmati.",
      icon: Hotel,
    ...
    },
    {
      ...
      features: [
        { text: "Avtomobillar", icon: Star },
        { text: "Poyezd Bilet Xizmati", icon: CheckCircle },
        { text: "Airport transfer", icon: Car },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-20">
          ...
          <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
            Sayohatingizni mukammal qilish uchun professional va yuqori sifatli
            ...
            return (
              ...
              >
                <CardHeader className="text-center pb-6">
                  <div
                    className={`w-20 h-20 mx-auto mb-6 rounded-2xl bg-gradient-to-r ${service.gradient} flex items-center justify-center transform group-hover:scale-110 transition-transform duration-300 shadow-lg`}
                  >
                  ...
                  <div className="mb-4">
                    <span
                      className={`inline-block px-4 py-2 rounded-full text-sm font-semibold bg-gradient-to-r ${service.gradient} text-white`}
                    >
                      {service.quality}
                    </span>
                  </div>
                  ...
                  <div className="space-y-4 mb-8">
                    {service.features.map((feature, featureIndex) => {
                      ...
                      return (
                        ...
                        >
                          <div
                            className={`w-8 h-8 rounded-full bg-gradient-to-r ${service.gradient} flex items-center justify-center mr-4 shadow-sm`}
                          >
