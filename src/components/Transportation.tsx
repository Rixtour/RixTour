...
const Transportation = () => {
  const transportOptions = [
    {
      ...
      description:
        "Luxury avtomobillar bilan aeroportdan mehmonxonaga premium transfer",
      icon: Plane,
    ...
    },
    {
      ...
      description:
        "Shahardagi barcha diqqatga sazovor joylarni tezkor poyezlar bilan",
      icon: Train,
    ...
    },
    {
      ...
      description:
        "Samarqand, Buxoro, Xiva orasida hashamatli avtobuslar bilan sayohat",
      icon: Bus,
    ...
    },
    {
      ...
      description:
        "Maxsus tadbirlar uchun eng yuqori darajadagi executive transport",
      icon: Crown,
  ...
  return (
    <section
      id="transportation"
      className="py-24 bg-gradient-to-br from-gray-50 via-white to-slate-50"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-20">
          ...
          <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
            Luxury va professional transport xizmatlari bilan O'zbekiston
            bo'ylab qulay sayohat qiling
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {transportOptions.map((option, index) => {
            ...
            return (
              <Card
                key={index}
                className="group h-full hover:shadow-2xl transition-all duration-500 border-0 bg-white shadow-lg transform hover:-translate-y-4"
              >
                <CardHeader className="text-center pb-6">
                  <div
                    className={`w-20 h-20 mx-auto mb-6 rounded-2xl bg-gradient-to-r ${option.gradient} flex items-center justify-center transform group-hover:scale-110 transition-transform duration-300 shadow-lg`}
                  >
                  ...
                  <div className="mb-4">
                    <span
                      className={`inline-block px-4 py-2 rounded-full text-sm font-semibold bg-gradient-to-r ${option.gradient} text-white`}
                    >
                      {option.quality}
                    </span>
                  </div>
                  ...
                  <div className="space-y-4">
                    {option.features.map((feature, fIndex) => {
                      ...
                      return (
                        ...
                        >
                          <div
                            className={`w-8 h-8 rounded-full bg-gradient-to-r ${option.gradient} flex items-center justify-center mr-4 shadow-sm`}
                          >
        ...
        <div className="mt-16 bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 rounded-3xl p-12 text-white text-center shadow-2xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            <div className="bg-white/20 backdrop-blur-sm rounded-2xl p-6">
              <div className="text-4xl font-bold mb-2">Standart</div>
              <div className="text-lg">3-5 kunlik sayohat</div>
            </div>
