...
const Hotels = () => {
  ...
  return (
    <section id="hotels" className="py-24 bg-gradient-to-br from-amber-50 via-white to-orange-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-20">
          <div className="inline-flex items-center bg-gradient-to-r from-amber-100 to-orange-100 rounded-full px-6 py-3 mb-6">
            ...
            <span className="text-amber-700 font-semibold">Premium Turar Joylar</span>
          </div>
          ...
          <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
            Yuqori sifatli mehmonxonalarda qoling va O'zbekiston go'zalligidan professional xizmat bilan zavqlaning
          </p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {hotels.map((hotel, index) => (
            <Card key={index} className="group overflow-hidden hover:shadow-2xl transition-all duration-500 bg-white border-0 shadow-lg transform hover:-translate-y-4">
              <div className="relative overflow-hidden">
                ...
                <div className="absolute top-4 right-4 bg-white/95 backdrop-blur-sm rounded-full px-3 py-2 flex items-center shadow-lg">
                  ...
                  <span className="ml-1 text-sm font-bold text-gray-800">{hotel.rating}.0</span>
                </div>
                ...
                <div className="absolute bottom-4 left-4 text-white">
                  <div className="text-sm font-medium text-amber-300 mb-1">{hotel.category}</div>
              ...
              <CardContent className="pt-0">
                <div className="space-y-3">
                  {hotel.amenities.map((amenity, aIndex) => {
                    ...
                    return (
                      <div key={aIndex} className="flex items-center text-gray-700">
