...
const Places = () => {
  ...
  const places = [
    {
      name: 'Samarqand',
      description: 'UNESCO merosi - Registon maydoni va Temur maqbarasi bilan mashhur qadimiy shahar',
    ...
    {
      name: 'Buxoro',
      description: 'Qadimiy Ipak yo\'li shahri - ming yillik tarix va madaniyat markazi',
    ...
    {
      name: 'Xiva',
      description: 'Ichon Qala - dunyo bo\'ylab mashhur ochiq osmon ostidagi muzeyi',
    ...
    {
      name: 'Toshkent',
      description: 'O\'zbekistonning zamonaviy poytaxti - an\'ana va modernlikning uyg\'unligi',
  ...
  return (
    <section id="places" className="py-24 bg-gradient-to-br from-indigo-50 via-white to-purple-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-20">
          <div className="inline-flex items-center bg-gradient-to-r from-indigo-100 to-purple-100 rounded-full px-6 py-3 mb-6">
            ...
            <span className="text-indigo-700 font-semibold">Premium Yo'nalishlar</span>
          </div>
          ...
          <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
            O'zbekistonning eng go'zal va tarixiy joylarini professional gidlar bilan kashf eting
          </p>
        </div>
            ...
            >
              <div className="relative overflow-hidden">
                ...
                <div className="absolute top-4 right-4 bg-white/95 backdrop-blur-sm rounded-full px-3 py-2 flex items-center shadow-lg">
                  ...
                  <span className="ml-1 text-sm font-bold text-gray-800">{place.rating}</span>
                </div>
