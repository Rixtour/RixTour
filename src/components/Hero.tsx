  ...
  return (
    <section id="hero" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center text-white px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto">
        ...
        <h1 className="text-5xl md:text-7xl font-extrabold mb-8 animate-fade-in">
          O'zbekiston bo'ylab
        ...
        <p className="text-xl md:text-2xl mb-12 text-gray-100 animate-fade-in opacity-90 max-w-3xl mx-auto leading-relaxed">
          Ipak yo'li merosi, qadimiy shaharlar va zamonaviy qulayliklar bilan tanishing. 
          Professional xizmatlarimiz bilan eng yaxshi sayohat tajribasini yaşang.
        </p>
        ...
        <div className="flex flex-col sm:flex-row gap-6 justify-center animate-fade-in">
          ...
          <Button 
            ...
            size="lg"
            variant="outline"
            className="border-3 border-white/40 text-white hover:bg-white/10 backdrop-blur-sm px-10 py-6 text-xl font-bold rounded-2xl transition-all duration-300 hover:scale-110 hover:shadow-2xl hover:border-white/60"
          >
            Xizmatlarni Ko'rish
          </Button>
        </div>
      ...
      <button 
        ...
        className="absolute bottom-8 left-1/2 transform -translate-x-1/2 animate-bounce cursor-pointer hover:scale-125 transition-transform duration-200"
      >
